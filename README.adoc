...
ifdef::env-github[]
image::docs/images/UI-Timetable.png[width="600"]
endif::[]

ifndef::env-github[]
image::images/UI-Timetable.png[width="600"]
endif::[]

ifdef::env-github[]
image::docs/images/UI-Notes.png[width="600"]
endif::[]

ifndef::env-github[]
image::images/UI-Notes.png[width="600"]
endif::[]

ifdef::env-github[]
image::docs/images/UI-CAP.png[width="600"]
endif::[]

ifndef::env-github[]
image::images/UI-CAP.png[width="600"]
endif::[]
