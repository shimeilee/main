...
*** Modified AddressBook's `add`, `delete`, `edit`, `list` and `find` command to guide users on what `add`,
    `delete`, `edit`, `list` and `find` command UltiStudent has to offer. (Pull request
    https://github.com/cs2103-ay1819s2-w09-1/main/pull/99/files?file-filters%5B%5D=[#99],
    https://github.com/cs2103-ay1819s2-w09-1/main/pull/185/files?file-filters%5B%5D=[#185])

** Documentation:
*** Updated existing contents of the User and Developer Guide:
*** Update and Maintain README. (Pull Request:
