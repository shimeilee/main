...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        /* Case: filtered person list, edit index within bounds of homework manager and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of homework manager but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
