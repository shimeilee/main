...
//        assertCommandFailure(command, AddCommand.MESSAGE_DUPLICATE_PERSON);
//
//        /* Case: add a duplicate person except with different ultistudent -> rejected */
...
//        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
//
//        /* Case: missing ultistudent -> rejected */
...
//
//        /* Case: invalid ultistudent -> rejected */
...
//     * {@code toAdd}.<br>
//     * 4. {@code Storage} and {@code SubInfoPanel} equal to the corresponding components in
...
//     * 2. {@code Storage} and {@code SubInfoPanel} equal to the corresponding components in
...
//     * 4. {@code Storage} and {@code SubInfoPanel} remain unchanged.<br>
